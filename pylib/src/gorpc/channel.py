...
from gorpc.error import RpcError

# Module imports
import rpc_pb2 as rpc_pb
from gorpc import logger
...
class SocketRpcChannel(service.RpcChannel):
    ...
    def sendRpcMessage(self, sock, rpcRequest):
        ...
        try:
            #print "writing data : " + str(len(rpcRequest.SerializeToString()))
    ...
    def tryToRetrieveServiceResponse(self, response_class):
            ...
            if self.rpcResponse.HasField('response_proto'):
                ...
                try:
                    self.serviceResponse = self.parseResponse(
    ...
    def CallMethod(self, method, controller, request, response_class, done):
        ...
        sock = self.openSocket(self.host, self.port)
        ...
        self.rpcResponse = self.parseResponse(self.reply,
                                                    rpc_pb.Response)
        self.serviceResponse =  self.parseResponse(
